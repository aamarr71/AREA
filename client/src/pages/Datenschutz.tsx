  ...
  return (
    <div className="min-h-screen flex flex-col">
      <main className="flex-1 container max-w-2xl py-8 px-4">
        ...
        <p className="text-xs text-muted-foreground mb-6">Stand: April 2026</p>

        {/* Inhaltsverzeichnis */}
        <nav className="border-y border-white/10 py-4 my-6">
          <div className="space-y-1 text-sm text-muted-foreground leading-relaxed">
            <p><a href="#section-1" className="hover:text-foreground transition-colors">1. Verantwortlicher und Kontaktdaten</a></p>
            <p><a href="#section-2" className="hover:text-foreground transition-colors">2. Allgemeine Hinweise zur Datenverarbeitung und Rechtsgrundlagen</a></p>
            <p><a href="#section-3" className="hover:text-foreground transition-colors">3. Erhebung und Verarbeitung personenbezogener Daten im Einzelnen</a></p>
            <p><a href="#section-4" className="hover:text-foreground transition-colors">4. Einsatz von Systemen künstlicher Intelligenz</a></p>
            <p><a href="#section-5" className="hover:text-foreground transition-colors">5. Cookies und vergleichbare Technologien</a></p>
            <p><a href="#section-6" className="hover:text-foreground transition-colors">6. Datenweitergabe an Dritte und Auftragsverarbeiter</a></p>
            <p><a href="#section-7" className="hover:text-foreground transition-colors">7. Übermittlung personenbezogener Daten in Drittländer</a></p>
            <p><a href="#section-8" className="hover:text-foreground transition-colors">8. Speicherdauer und Löschung personenbezogener Daten</a></p>
            <p><a href="#section-9" className="hover:text-foreground transition-colors">9. Datensicherheit und technische Maßnahmen</a></p>
            <p><a href="#section-10" className="hover:text-foreground transition-colors">10. Rechte der betroffenen Personen</a></p>
            <p><a href="#section-11" className="hover:text-foreground transition-colors">11. Beschwerderecht bei der Aufsichtsbehörde</a></p>
            <p><a href="#section-12" className="hover:text-foreground transition-colors">12. Änderungen dieser Datenschutzerklärung</a></p>
          </div>
        </nav>
        ...
        <div className="divide-y divide-white/10">
          ...
          {/* 1 */}
          <section id="section-1" className="pb-8">
            <h2 className="text-lg font-semibold mb-3">1. Verantwortlicher und Kontaktdaten</h2>
          ...
          {/* 2 */}
          <section id="section-2" className="py-8">
            <h2 className="text-lg font-semibold mb-3">2. Allgemeine Hinweise zur Datenverarbeitung und Rechtsgrundlagen</h2>
            <p className="text-sm text-muted-foreground leading-normal">
            ...
            <p className="text-sm text-muted-foreground leading-normal mt-4">
          ...
          {/* 3 */}
          <section id="section-3" className="py-8">
            <h2 className="text-lg font-semibold mb-6">3. Erhebung und Verarbeitung personenbezogener Daten im Einzelnen</h2>

            <div className="space-y-8">
              <div>
                <h3 className="text-base font-medium mb-2">3.1 Bereitstellung der Website und Erstellung von Protokolldateien (Server-Logfiles)</h3>
                <p className="text-sm text-muted-foreground leading-normal">
                ...
                <div className="mt-3 pl-4 space-y-1">
                  <p className="text-sm text-muted-foreground leading-normal">— die IP-Adresse des anfragenden Rechners</p>
                  <p className="text-sm text-muted-foreground leading-normal">— Datum und Uhrzeit des Zugriffs (Zeitstempel)</p>
                  <p className="text-sm text-muted-foreground leading-normal">— die angeforderte URL einschließlich der verwendeten HTTP-Methode</p>
                  <p className="text-sm text-muted-foreground leading-normal">— den HTTP-Statuscode der Serverantwort</p>
                  <p className="text-sm text-muted-foreground leading-normal">— die übertragene Datenmenge in Byte</p>
                  <p className="text-sm text-muted-foreground leading-normal">— die Referrer-URL (die zuvor besuchte Seite, soweit vom Browser übermittelt)</p>
                  <p className="text-sm text-muted-foreground leading-normal">— den verwendeten Webbrowser sowie dessen Version</p>
                  <p className="text-sm text-muted-foreground leading-normal">— das verwendete Betriebssystem</p>
                </div>
                <p className="text-sm text-muted-foreground leading-normal mt-3">
              ...
              <div>
                <h3 className="text-base font-medium mb-2">3.2 Registrierung und Nutzerkonten</h3>
                <p className="text-sm text-muted-foreground leading-normal">
                ...
                <div className="mt-2 pl-4 space-y-1">
                  <p className="text-sm text-muted-foreground leading-normal">— E-Mail-Adresse</p>
                  <p className="text-sm text-muted-foreground leading-normal">— Vor- und Nachname</p>
                  <p className="text-sm text-muted-foreground leading-normal">— Passwort (das Passwort wird ausschließlich in kryptographisch gehashter Form unter Verwendung des bcrypt-Algorithmus gespeichert; eine Speicherung oder Kenntnisnahme des Klartextpassworts durch den Verantwortlichen ist technisch ausgeschlossen)</p>
                </div>
                <p className="text-sm text-muted-foreground leading-normal mt-3">
              ...
              <div>
                <h3 className="text-base font-medium mb-2">3.3 Sitzungsverwaltung (Session-Cookies)</h3>
                <p className="text-sm text-muted-foreground leading-normal">
              ...
              <div>
                <h3 className="text-base font-medium mb-2">3.4 Analyse von Immobilien-Exposés (Kernfunktionalität)</h3>
                <p className="text-sm text-muted-foreground leading-normal">
                ...
                <div className="mt-2 pl-4 space-y-1">
                  <p className="text-sm text-muted-foreground leading-normal">— die vom Nutzer eingegebene URL des Exposés</p>
                  <p className="text-sm text-muted-foreground leading-normal">— der öffentlich zugängliche Textinhalt der unter dieser URL abrufbaren Webseite</p>
                  <p className="text-sm text-muted-foreground leading-normal">— ein kryptographischer Hash (SHA-256) des abgerufenen Seiteninhalts zum Zweck der Cache-Steuerung</p>
                  <p className="text-sm text-muted-foreground leading-normal">— das Analyse-Ergebnis (strukturierter Report)</p>
                  <p className="text-sm text-muted-foreground leading-normal">— Metadaten des Analysevorgangs (Zeitpunkt, Dauer, Fehlerstatus)</p>
                </div>
                <p className="text-sm text-muted-foreground leading-normal mt-3">
              ...
              <div>
                <h3 className="text-base font-medium mb-2">3.5 Report-Übersetzung</h3>
                <p className="text-sm text-muted-foreground leading-normal">
              ...
              <div>
                <h3 className="text-base font-medium mb-2">3.6 Administration und Nutzerverwaltung</h3>
                <p className="text-sm text-muted-foreground leading-normal">
          ...
          {/* 4 */}
          <section id="section-4" className="py-8">
            <h2 className="text-lg font-semibold mb-3">4. Einsatz von Systemen künstlicher Intelligenz</h2>
            <p className="text-sm text-muted-foreground leading-normal">
          ...
          <section id="section-5" className="py-8">
            <h2 className="text-lg font-semibold mb-3">5. Cookies und vergleichbare Technologien</h2>
            <p className="text-sm text-muted-foreground leading-normal">
            ...
            <div className="mt-3 pl-4 space-y-1">
              <p className="text-sm text-muted-foreground leading-normal"><strong>Session-Cookie (connect.sid)</strong></p>
              <p className="text-sm text-muted-foreground leading-normal">— Zweck: Authentifizierung und Sitzungszuordnung eingeloggter Nutzer</p>
              <p className="text-sm text-muted-foreground leading-normal">— Rechtsgrundlage: § 165 Abs. 3 TKG 2021 (unbedingt erforderliches Cookie); Art. 6 Abs. 1 lit. b DSGVO (Vertragserfüllung)</p>
              <p className="text-sm text-muted-foreground leading-normal">— Lebensdauer: 7 Tage ab dem letzten Zugriff oder bis zum manuellen Logout durch den Nutzer</p>
              <p className="text-sm text-muted-foreground leading-normal">— Übermittlung an Dritte: Nein</p>
              <p className="text-sm text-muted-foreground leading-normal">— Art: HTTP-only, Secure, SameSite: Lax</p>
            </div>
            <p className="text-sm text-muted-foreground leading-normal mt-4">
          ...
          {/* 6 */}
          <section id="section-6" className="py-8">
            <h2 className="text-lg font-semibold mb-3">6. Datenweitergabe an Dritte und Auftragsverarbeiter</h2>
            <p className="text-sm text-muted-foreground leading-normal">
          ...
          {/* 7 */}
          <section id="section-7" className="py-8">
            <h2 className="text-lg font-semibold mb-3">7. Übermittlung personenbezogener Daten in Drittländer</h2>
            <p className="text-sm text-muted-foreground leading-normal">
          ...
          {/* 8 */}
          <section id="section-8" className="py-8">
            <h2 className="text-lg font-semibold mb-3">8. Speicherdauer und Löschung personenbezogener Daten</h2>
            <p className="text-sm text-muted-foreground leading-normal">
            ...
            <div className="mt-2 pl-4 space-y-1">
              <p className="text-sm text-muted-foreground leading-normal">(a) Server-Logfiles: 30 Tage</p>
              <p className="text-sm text-muted-foreground leading-normal">(b) Session-Daten: Bis zum Logout des Nutzers, spätestens 7 Tage nach dem letzten Zugriff</p>
              <p className="text-sm text-muted-foreground leading-normal">(c) Account-Daten: Für die Dauer des Vertragsverhältnisses, danach gemäß den gesetzlichen Aufbewahrungspflichten (insbesondere §§ 131, 132 BAO: bis zu 7 Jahre für steuerlich relevante Unterlagen)</p>
              <p className="text-sm text-muted-foreground leading-normal">(d) Analyse-Ergebnisse: Für die Dauer des Vertragsverhältnisses; nach Beendigung des Vertragsverhältnisses werden die Analyse-Ergebnisse innerhalb von 90 Tagen gelöscht, sofern keine gesetzlichen Aufbewahrungspflichten entgegenstehen</p>
              <p className="text-sm text-muted-foreground leading-normal">(e) In-Memory-Cache: 60 Minuten; bei Neustart des Servers werden die Cache-Daten automatisch gelöscht</p>
              <p className="text-sm text-muted-foreground leading-normal">(f) In-Memory-Metriken: Bis zum nächsten Neustart des Servers; es handelt sich um aggregierte, nicht personenbezogene Nutzungsstatistiken</p>
            </div>
          </section>

          {/* 9 */}
          <section id="section-9" className="py-8">
            <h2 className="text-lg font-semibold mb-3">9. Datensicherheit und technische Maßnahmen</h2>
            <p className="text-sm text-muted-foreground leading-normal">
            ...
            <div className="mt-3 pl-4 space-y-1">
              <p className="text-sm text-muted-foreground leading-normal">— Verschlüsselung der Datenübertragung mittels TLS/HTTPS</p>
              <p className="text-sm text-muted-foreground leading-normal">— Kryptographisches Hashing von Passwörtern (bcrypt)</p>
              <p className="text-sm text-muted-foreground leading-normal">— Sitzungsverwaltung mittels signierter, serverseitiger Session-Tokens (httpOnly, Secure, SameSite)</p>
              <p className="text-sm text-muted-foreground leading-normal">— SSRF-Schutz (Server-Side Request Forgery) durch DNS-Validierung und IP-Blacklisting</p>
              <p className="text-sm text-muted-foreground leading-normal">— HTTP-Security-Header (Content-Security-Policy, X-Frame-Options, X-Content-Type-Options und weitere) mittels Helmet.js</p>
              <p className="text-sm text-muted-foreground leading-normal">— Ratenbegrenzung (Rate Limiting) zur Abwehr von Denial-of-Service-Angriffen und missbräuchlicher Nutzung</p>
              <p className="text-sm text-muted-foreground leading-normal">— PII-Redaction (automatisierte Erkennung und Entfernung personenbezogener Daten) vor der Übermittlung an externe Übersetzungsdienste</p>
              <p className="text-sm text-muted-foreground leading-normal">— Zugriffskontrolle durch rollenbasierte Autorisierung (Trennung von Nutzer- und Administratorrechten)</p>
            </div>
            <p className="text-sm text-muted-foreground leading-normal mt-4">
          ...
          {/* 10 */}
          <section id="section-10" className="py-8">
            <h2 className="text-lg font-semibold mb-3">10. Rechte der betroffenen Personen</h2>
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-base font-medium mb-2">10.1 Recht auf Auskunft (Art. 15 DSGVO)</h3>
                <p className="text-sm text-muted-foreground leading-normal">
              ...
              <div>
                <h3 className="text-base font-medium mb-2">10.2 Recht auf Berichtigung (Art. 16 DSGVO)</h3>
                <p className="text-sm text-muted-foreground leading-normal">
              ...
              <div>
                <h3 className="text-base font-medium mb-2">10.3 Recht auf Löschung (Art. 17 DSGVO)</h3>
                <p className="text-sm text-muted-foreground leading-normal">
              ...
              <div>
                <h3 className="text-base font-medium mb-2">10.4 Recht auf Einschränkung der Verarbeitung (Art. 18 DSGVO)</h3>
                <p className="text-sm text-muted-foreground leading-normal">
              ...
              <div>
                <h3 className="text-base font-medium mb-2">10.5 Recht auf Datenübertragbarkeit (Art. 20 DSGVO)</h3>
                <p className="text-sm text-muted-foreground leading-normal">
              ...
              <div>
                <h3 className="text-base font-medium mb-2">10.6 Widerspruchsrecht (Art. 21 DSGVO)</h3>
                <p className="text-sm text-muted-foreground leading-normal">
              ...
              <div>
                <h3 className="text-base font-medium mb-2">10.7 Recht auf Widerruf der Einwilligung (Art. 7 Abs. 3 DSGVO)</h3>
                <p className="text-sm text-muted-foreground leading-normal">
          ...
          {/* 11 */}
          <section id="section-11" className="py-8">
            <h2 className="text-lg font-semibold mb-3">11. Beschwerderecht bei der Aufsichtsbehörde</h2>
            <p className="text-sm text-muted-foreground leading-normal">
          ...
          {/* 12 */}
          <section id="section-12" className="pt-8">
            <h2 className="text-lg font-semibold mb-3">12. Änderungen dieser Datenschutzerklärung</h2>
            <p className="text-sm text-muted-foreground leading-normal">
